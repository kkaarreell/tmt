...
rlJournalStart
    ...
    rlPhaseStartTest
        ...
        rlRun "tar tzf $BUNDLE_PATH | grep /this_file.txt" 0 "Bundle contains an expected file"

        # FIXME - Present this information somehow to the user (that they have some files...)
    rlPhaseEnd
